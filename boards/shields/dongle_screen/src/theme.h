...
// Theme selection based on Kconfig
    ...
    #define THEME_BATTERY_CRITICAL    LV_COLOR_MAKE(0xF7, 0x76, 0x8E)  // Red
    #define THEME_BATTERY_LOW         LV_COLOR_MAKE(0xFF, 0x9E, 0x64)  // Orange
    #define THEME_BATTERY_MEDIUM      LV_COLOR_MAKE(0xE0, 0xAF, 0x68)  // Yellow
    #define THEME_BATTERY_GOOD        LV_COLOR_MAKE(0x9E, 0xCE, 0x6A)  // Green
    #define THEME_BATTERY_FULL        LV_COLOR_MAKE(0x7D, 0xCF, 0xFF)  // Cyan
    
    #define THEME_CAPS_ACTIVE         LV_COLOR_MAKE(0x9E, 0xCE, 0x6A)  // Green
    #define THEME_NUM_ACTIVE          LV_COLOR_MAKE(0x7A, 0xA2, 0xF7)  // Blue
    #define THEME_SCROLL_ACTIVE       LV_COLOR_MAKE(0xBB, 0x9A, 0xF7)  // Purple
    #define THEME_CAPS_WORD_ACTIVE    LV_COLOR_MAKE(0xE0, 0xAF, 0x68)  // Yellow
    #define THEME_LOCK_INACTIVE       LV_COLOR_MAKE(0x41, 0x4B, 0x68)  // Dark Blue-Grey
    
    #define THEME_USB_CONNECTED       LV_COLOR_MAKE(0xFF, 0x9E, 0x64)  // Orange
    #define THEME_USB_DISCONNECTED    LV_COLOR_MAKE(0xF7, 0x76, 0x8E)  // Red
    #define THEME_BLE_CONNECTED       LV_COLOR_MAKE(0x7A, 0xA2, 0xF7)  // Blue
    #define THEME_BLE_BONDED          LV_COLOR_MAKE(0x9E, 0xCE, 0x6A)  // Green
    #define THEME_BLE_INACTIVE        LV_COLOR_MAKE(0x41, 0x4B, 0x68)  // Dark Blue-Grey
    
    #define THEME_WPM_START           LV_COLOR_MAKE(0xE0, 0xAF, 0x68)  // Yellow
    #define THEME_WPM_END             LV_COLOR_MAKE(0x7A, 0xA2, 0xF7)  // Blue
    #define THEME_WPM_BORDER          LV_COLOR_MAKE(0x41, 0x4B, 0x68)  // Dark Blue-Grey
    
    #define THEME_LAYER_ACTIVE        LV_COLOR_MAKE(0x7D, 0xCF, 0xFF)  // Cyan
    #define THEME_LAYER_INACTIVE      LV_COLOR_MAKE(0x41, 0x4B, 0x68)  // Dark Blue-Grey
    #define THEME_LAYER_TEXT          LV_COLOR_MAKE(0xC0, 0xCA, 0xF5)  // Foreground
    
    #define THEME_BACKGROUND          LV_COLOR_MAKE(0x1A, 0x1B, 0x26)  // Background
    #define THEME_TEXT_PRIMARY        LV_COLOR_MAKE(0xC0, 0xCA, 0xF5)  // Foreground
    #define THEME_TEXT_SECONDARY      LV_COLOR_MAKE(0x56, 0x5F, 0x89)  // Comment
    #define THEME_BORDER              LV_COLOR_MAKE(0x41, 0x4B, 0x68)  // Dark Blue-Grey
    #define THEME_INACTIVE            LV_COLOR_MAKE(0x41, 0x4B, 0x68)  // Dark Blue-Grey
